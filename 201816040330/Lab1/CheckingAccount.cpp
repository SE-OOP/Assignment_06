...
CheckingAccount::CheckingAccount(double ba,double fe)
:Account(ba)
{
    fee=fe;
...
void CheckingAccount::credit(double fe)
{
    Account::credit(fe);
}
...
bool CheckingAccount::debit(double fe)
{
    Account::debit(fe);
}
...
{
    double i=Account::getBalance()-fee;
