...
int main()
{
    Package package1("yhk","fangzi","luoyang","zhengzhou","123","123",2,3);
    TwoDayPackage package2("lulu","xixi","xinxiang","zhengzhou","456","456",4,5,6);
    OvernightPackage package3("xiaoming","a0~","mamyamg","zhengzhou","789","789",7,8,9 );//creat object
